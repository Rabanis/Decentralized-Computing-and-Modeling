...
to setup-turtles
  ...
  create-turtles number-of-nodes [
    ...
    set chaining? false
    set single? false
    set pointer -1  ;; null pointers are -1
  ]
...
to Function
  set matched_nodes count turtles with[matched? = true]
  set free_nodes count turtles with[free? = true]
  set waiting_nodes count turtles with[waiting? = true]
  set chaining_nodes count turtles with[chaining? = true]
end
...
"" ""
PENS
"default" 1.0 0 -13345367 true "" "plot matched_nodes"
"pen-1" 1.0 0 -14439633 true "" "plot free_nodes"
"pen-2" 1.0 0 -2674135 true "" "plot waiting_nodes"
"pen-3" 1.0 0 -955883 true "" "plot chaining_nodes"
